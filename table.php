<?php include "Lib/dbConnection.class.php";?>
<!DOCTYPE html>
<html lang="en"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta name="author" content="Neeraj Kumar Sharma/neerajdexter@gmail.com">
    <link rel="icon" href="https://internal.egi.ericsson.com/sites/default/files/econ-white.jpg">

    <title>License Repository</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><img src="https://internal.egi.ericsson.com/sites/default/files/econ-white.jpg" style="height:35px" /></a>
        </div>
    </nav>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12 col-md-12 main">
         <h2 class="sub-header">License Repository</h2>
